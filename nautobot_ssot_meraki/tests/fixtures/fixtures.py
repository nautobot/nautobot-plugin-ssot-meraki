...
GET_MANAGEMENT_PORT_NAMES_RECV_FIXTURE = load_json(
    "./nautobot_ssot_meraki/tests/fixtures/get_management_port_names_recv.json"
)
...
GET_APPLIANCE_SWITCHPORTS_FIXTURE = load_json("./nautobot_ssot_meraki/tests/fixtures/get_appliance_switchports.json")
